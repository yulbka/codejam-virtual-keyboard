...
const keysEng = [{ value: '`', switchValue: '~', classes: ['key_switched'] }, { value: '1', switchValue: '!', classes: ['key_switched'] },
  ...
  { value: '0', switchValue: ')' }, { value: '-', switchValue: '_', classes: ['key_switched'] }, { value: '=', switchValue: '+', classes: ['key_switched'] },
  { value: 'Backspace', classes: ['key_wide'] }, { value: 'Tab' }, { value: 'q' }, { value: 'w' }, { value: 'e' }, { value: 'r' },
  { value: 't' }, { value: 'y' }, { value: 'u' }, { value: 'i' }, { value: 'o' }, { value: 'p' }, { value: '[' }, { value: ']' },
  { value: '\\', switchValue: '|', classes: ['key_switched'] }, { value: 'Del' }, { value: 'CapsLock', classes: ['key_wide', 'key_caps'] },
  { value: 'a' }, { value: 's' }, { value: 'd' }, { value: 'f' }, { value: 'g' }, { value: 'h' }, { value: 'j' }, { value: 'k' },
  { value: 'l' }, { value: ';' }, { value: '\\' }, { value: 'Enter', classes: ['key_wide'] }, { value: 'Shift', classes: ['key_wide'] },
  { value: 'z' }, { value: 'x' }, { value: 'c' }, { value: 'v' }, { value: 'b' }, { value: 'n' }, { value: 'm' }, { value: ',' },
  { value: '.' }, { value: '/' }, { value: '↑' }, { value: 'Shift', classes: ['key_wide'] }, { value: 'Ctrl' }, { value: 'Win' },
  { value: 'Alt' }, { value: ' ', classes: ['key_space'] }, { value: 'Alt' }, { value: '←' }, { value: '↓' }, { value: '→' }, { value: 'Ctrl' }];
